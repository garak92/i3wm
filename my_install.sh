...
sudo pacman -S picom imagemagick xss-lock i3lock rofi nitrogen autorandr otf-font-awesome lutris steam libreoffice-fresh galculator nvidia nvidia-prime htop pavucontrol vim bluez blueman
